...
#    password = getpass()
    ...
    #    output = net_connect.config_mode("logging buffered 7000")
        output = net_connect.send_config_set(config_commands) + net_connect.send_command('sh run | i logging')
    #    output = net_output
        ...
        print output
#        print "show run | i logging:"
#        print net_connect.send_command('show run | i logging')
        print '#' * 80
